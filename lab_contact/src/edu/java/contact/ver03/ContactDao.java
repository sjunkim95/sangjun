...
public interface ContactDao { // (Data Access Object) -> 저장, 수정, 삭제, 검색.
     ...
     * @return Contact 객체를 리턴. 해당 인덱스의 연락처 정보가 없는 경우에는 null을 리턴.
     */
     ...
     */
    int create(Contact contact); // Create 클래스에 Contact argument로, contact 리스트에 저장하겠다.
     ...
     */
    int update(int index, Contact contact); // String n, String p, String e -> 이런식으로 가능하지만, 이 정보가 다 contact 안에 있어.
