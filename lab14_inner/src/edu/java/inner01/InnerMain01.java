 ...
 *  
 * 내부 클래스(inner class/interface, nested class): 다른 클래스/인터페이스의 내부에서 선언하는 클래스/인터페이스.
...
public class InnerMain01 {
    ...
    public static void main(String[] args) {
        ...
        // app 이 선언되어야, stack이라는 공간에 app 변수가 생성됨,
        // app 변수 지워지는 시점은 메서드가 끝나는 시점.
        
//        System.out.println("x = " + InnerMain01.x); -> 이게 안됨, 내부에서 app 으로 선언을 미리 해줘야
        System.out.println("x = " + app.x);
//        System.out.println("x = " + app.MAX); -> static 멤버 변수이니까, 얘는 이게 가능하지.
