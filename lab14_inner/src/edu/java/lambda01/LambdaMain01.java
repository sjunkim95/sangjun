...
public class LambdaMain01 {
    ...
    public static void main(String[] args) {
        ...
        // main 메서드 끝날때까지 이 변수는 사용할 수 있는것이다.
        System.out.println(result);
        
        // 3. 익명 클래스(local class)
...
//        Printable printer3 = msg -> System.out.println(msg);
      ...
      //  Mapper mapper = s -> s.length(); // 파라미터 하나면 s에 () 없어도 된다.
        Mapper mapper = String::length; // 파라미터가 문자열이니까, 문자열이 가진 length를 호출하겠다.
