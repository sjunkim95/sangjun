 ...
 *  OutputStream
 *  |__ FileOutputStream, BufferedOutputStream, ObejctOutputStream
 *  
...
public class FileMain09 {
    ...
    public static void main(String[] args) {
        ...
        try(
                ...
                InputStreamReader reader = new InputStreamReader(in, "EUC-KR"); // 리딩할 때 인코딩 타입을 써준다.
                BufferedReader br = new BufferedReader(reader); // 메모리에서 읽어드려서 속도를 더 빠르게 하기 위해서.
        ){
            while(true) {
                int read = br.read(); // reader.read();이 아닌, 이것도 사용 가능
                if (read == -1) { // EOF
                    break;
                }
